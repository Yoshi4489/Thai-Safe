...
class _ReportIncidentPageState extends ConsumerState<ReportIncidentPage> {
  ...
  final TextEditingController _floodPeopleCountController =
      TextEditingController();
  final TextEditingController _floodMedicationController =
      TextEditingController();
        ...
        Padding(
          ...
          child: Row(
            children: levels.map((level) {
              ...
              Color color = level == 'ถึงแก่ชีวิต'
                  ? Colors.red
                  : (level == 'ด่วนมาก' ? Colors.orange : Colors.green);
              return Expanded(
                child: Padding(
  ...
  Widget _buildNumberField(
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        autovalidateMode: validateNonZero
  ...
  Widget _buildDynamicFields() {
        ...
        children.add(
          Column(
            ...
            children: [
              ...
              _buildSwitch(
                'มีผู้รอรับความช่วยเหลือ หรือไม่',
                _floodHasPeopleWaiting,
                (v) => setState(() => _floodHasPeopleWaiting = v),
              ),
              if (_floodHasPeopleWaiting)
                _buildNumberField(
                  'จำนวนผู้รอรับความช่วยเหลือ (ประมาณ)',
                  _floodPeopleCountController,
                  suffix: 'คน',
                  validateNonZero: true,
                ),
              _buildSwitch(
                'มีกระแสไฟฟ้า หรือไม่',
                _floodHasElectricity,
                (v) => setState(() => _floodHasElectricity = v),
              ),
              _buildSwitch(
                'มีผู้ป่วยติดเตียง หรือไม่',
                _floodHasBedridden,
                (v) => setState(() => _floodHasBedridden = v),
              ),
              ...
              _buildSegmented(
                ['สงบ', 'ปานกลาง', 'แรงมาก'],
                _floodWaterCurrent,
                (v) => setState(() => _floodWaterCurrent = v),
              ),
              ...
              _buildSegmented(
                ['ไม่ได้', 'ไม่แน่ใจ', 'ได้'],
                _floodBoatAccess,
                (v) => setState(() => _floodBoatAccess = v),
              ),
              const SizedBox(height: 12),
              _sectionLabel('อาหาร และน้ำมีเพียงพอ หรือไม่'),
              _buildSegmented(
                ['ไม่มีเลย', 'พอมี', 'เพียงพอ'],
                _floodSupplies,
                (v) => setState(() => _floodSupplies = v),
              ),
              const Divider(height: 24),
              _sectionLabel('ข้อมูลทางการแพทย์เพิ่มเติม'),
              _buildSwitch(
                'มีผู้ต้องการยาประจำตัว หรือไม่',
                _floodNeedMeds,
                (v) => setState(() => _floodNeedMeds = v),
              ),
              if (_floodNeedMeds)
                _buildTextField(
                  'โปรดระบุชื่อยา...',
                  _floodMedicationController,
                ),
              _buildSwitch(
                'มีผู้ที่มีโรคประจำตัวรุนแรง หรือไม่',
                _floodSevereDisease,
                (v) => setState(() => _floodSevereDisease = v),
              ),
              if (_floodSevereDisease)
                _buildTextField('โปรดระบุชื่อโรค...', _floodDiseaseController),
            ],
          ),
        );
        break;
        ...
        children.add(
          Column(
            ...
            children: [
              ...
              _buildDropdown(
                'ประเภทของไฟ',
                ['บ้าน/อาคาร', 'โรงงาน/สารเคมี', 'หญ้า/ป่า', 'ยานพาหนะ'],
                _fireType,
                (v) => setState(() => _fireType = v!),
              ),
              _sectionLabel('สถานะปัจจุบัน'),
              _buildSegmented(
                ['ควันเล็กน้อย', 'ไฟลามหนัก', 'คุมเพลิงได้'],
                _fireStatus,
                (v) => setState(() => _fireStatus = v),
              ),
              _buildSwitch(
                'มีคนติดอยู่ในพื้นที่ หรือไม่',
                _fireHasTrapped,
                (v) => setState(() => _fireHasTrapped = v),
              ),
              if (_fireHasTrapped)
                _buildNumberField(
                  'จำนวนผู้ติดอยู่ (คน)',
                  _fireTrappedCountCtrl,
                  validateNonZero: true,
                ),
              ...
              _buildDropdown(
                'จุดเสี่ยงใกล้เคียง',
                ['ไม่มี', 'ปั๊มน้ำมัน', 'แหล่งสารเคมี', 'เสาไฟฟ้าแรงสูง'],
                _fireRisk,
                (v) => setState(() => _fireRisk = v!),
              ),
              _sectionLabel('แหล่งน้ำใกล้เคียง'),
              _buildSegmented(
                ['มีประปา/หัวแดง', 'มีคลอง', 'ไม่มี'],
                _fireWaterSource,
                (v) => setState(() => _fireWaterSource = v),
              ),
              const Divider(height: 24),
              ...
              ..._fireNeeds.keys.map(
                (key) => _buildCheckbox(
                  key,
                  _fireNeeds[key]!,
                  (v) => setState(() => _fireNeeds[key] = v ?? false),
                ),
              ),
            ],
          ),
          ...
          Column(
            ...
            children: [
              ...
              _buildDropdown(
                ...
                _eqDamage,
                (v) => setState(() => _eqDamage = v!),
              ),
              _buildSwitch(
                'มีคนติดใต้ซากอาคาร หรือไม่',
                _eqHasTrapped,
                (v) => setState(() => _eqHasTrapped = v),
              ),
              if (_eqHasTrapped)
                _buildNumberField(
                  'จำนวนผู้ติดอยู่ (คน)',
              ...
              _buildDropdown(
                'ความเสี่ยงต่อเนื่อง',
                [
                  'ไม่มีความเสี่ยงต่อเนื่อง',
                  'ได้ยินเสียงอาคารลั่น',
                  'อยู่ใกล้หน้าผา/ดินสไลด์',
                  'อยู่ใกล้ชายฝั่ง (เสี่ยงสึนามิ)',
                ],
                _eqRisk,
                (v) => setState(() => _eqRisk = v!),
              ),
              const Divider(height: 24),
              _sectionLabel('สถานะสาธารณูปโภค'),
              ..._eqUtilities.keys.map(
                (key) => _buildCheckbox(
                  key,
                  _eqUtilities[key]!,
                  (v) => setState(() => _eqUtilities[key] = v ?? false),
                ),
              ),
              const Divider(height: 24),
              _sectionLabel('ความต้องการเร่งด่วน'),
              ..._eqNeeds.keys.map(
                (key) => _buildCheckbox(
                  key,
                  _eqNeeds[key]!,
                  (v) => setState(() => _eqNeeds[key] = v ?? false),
                ),
              ),
            ],
          ),
          ...
          Column(
            ...
            children: [
              ...
              _buildDropdown(
                ...
                _chemChar,
                (v) => setState(() => _chemChar = v!),
              ),
              _sectionLabel('สีของควัน/สารเคมี'),
              _buildSegmented(
                ['ใส/ไม่มีสี', 'ขาว', 'เหลือง/ส้ม', 'ดำ'],
                _chemColor,
                (v) => setState(() => _chemColor = v),
              ),
              _sectionLabel('ทิศทางลม'),
              _buildSegmented(
                ['ลมสงบ', 'พัดเข้าชุมชน', 'พัดออกชุมชน'],
                _chemWind,
                (v) => setState(() => _chemWind = v),
              ),
              _sectionLabel('พื้นที่ได้รับผลกระทบ'),
              _buildSegmented(
                ['ภายในอาคาร', 'รัศมี 500ม.', 'รัศมีเกิน 1กม.'],
                _chemArea,
                (v) => setState(() => _chemArea = v),
              ),
              const Divider(height: 12),
              _buildSwitch(
                'มีผู้ได้รับบาดเจ็บ หรือไม่',
                _chemHasInjured,
                (v) => setState(() => _chemHasInjured = v),
              ),
              if (_chemHasInjured) ...[
                _buildNumberField(
                ...
                _buildDropdown(
                  'อาการของผู้บาดเจ็บ',
                  ['แสบตา/ผิวหนัง', 'หายใจไม่ออก', 'หมดสติ', 'อาเจียน'],
                  _chemSymptom,
                  (v) => setState(() => _chemSymptom = v!),
                ),
              ],
              const Divider(height: 24),
              _sectionLabel('ความต้องการเร่งด่วน'),
              ..._chemNeeds.keys.map(
                (key) => _buildCheckbox(
                  key,
                  _chemNeeds[key]!,
                  (v) => setState(() => _chemNeeds[key] = v ?? false),
                ),
              ),
            ],
          ),
            ...
            children: [
              ...
              _buildDropdown(
                ...
                [
                  ...
                  'วิ่งราว/ชิงทรัพย์',
                  'ทะเลาะวิวาท',
                  'กราดยิง/จับตัวประกัน',
                ],
                _violType,
                (v) => setState(() => _violType = v!),
              ),
              _buildDropdown(
                'อาวุธที่พบ',
                ['ไม่มี/ไม่เห็น', 'มีด/ของมีคม', 'ปืน', 'ระเบิด'],
                _violWeapon,
                (v) => setState(() => _violWeapon = v!),
              ),
              _buildDropdown(
                'สถานะผู้ก่อเหตุ',
                ['ยังอยู่ในพื้นที่', 'หลบหนีไปแล้ว', 'ไม่ทราบ'],
                _violStatus,
                (v) => setState(() => _violStatus = v!),
              ),
              if (_violStatus == 'หลบหนีไปแล้ว')
                _buildTextField(
                  'พาหนะที่ใช้หลบหนี / ป้ายทะเบียน',
                  _violFledVehicleCtrl,
                  hint: 'เช่น มอเตอร์ไซค์สีแดง...',
                ),
              _buildTextField(
                'รูปพรรณสันฐานผู้ก่อเหตุ',
                _violSuspectCtrl,
                hint: 'เสื้อผ้าหน้าผม...',
              ),
              const Divider(height: 12),
              ...
              if (_violHasInjured) ...[
                ...
                _buildDropdown(
                  'อาการบาดเจ็บหลัก',
                  ['แผลถูกฟัน/ยิง', 'หมดสติ', 'บาดเจ็บเล็กน้อย'],
                  _violInjuryType,
                  (v) => setState(() => _violInjuryType = v!),
                ),
              ],
              const Divider(height: 12),
              _sectionLabel('ความปลอดภัยของคุณ'),
              _buildSegmented(
                ['ปลอดภัยแล้ว', 'กำลังซ่อนตัว', 'กำลังเผชิญหน้า'],
                _violSafety,
                (v) => setState(() => _violSafety = v),
              ),
              const Divider(height: 24),
              _sectionLabel('ความต้องการเร่งด่วน'),
              ..._violNeeds.keys.map(
                (key) => _buildCheckbox(
                  key,
                  _violNeeds[key]!,
                  (v) => setState(() => _violNeeds[key] = v ?? false),
                ),
              ),
            ],
          ),
        ...
        children.add(
          Column(
            ...
            children: [
              ...
              _buildSwitch(
                'มีผู้ได้รับผลกระทบ หรือไม่',
                _otherHasAffected,
                (v) => setState(() => _otherHasAffected = v),
              ),
              if (_otherHasAffected)
                _buildNumberField(
              ...
              const Divider(height: 24),
              _sectionLabel('ความต้องการเร่งด่วน'),
              ..._otherNeeds.keys.map(
                (key) => _buildCheckbox(
                  key,
                  _otherNeeds[key]!,
                  (v) => setState(() => _otherNeeds[key] = v ?? false),
                ),
              ),
            ],
          ),
    ...
    Color bgAlertColor = _urgency == 'ถึงแก่ชีวิต'
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: _urgency == 'ถึงแก่ชีวิต'
              ? Colors.red
              : (_urgency == 'ด่วนมาก' ? Colors.orange : Colors.blue.shade200),
          width: 1.5,
        ),
      ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                const Text(
                  'กรุณาเข้าสู่ระบบก่อนทำการแจ้งเหตุ เพื่อให้เจ้าหน้าที่สามารถยืนยันตัวตน และติดต่อกลับได้',
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              Text(
                '2. ข้อมูลเหตุการณ์และระดับความเร่งด่วน',
                style: theme.textTheme.titleMedium?.copyWith(
                  fontWeight: FontWeight.bold,
                ),
              ),
  ...
  void _submitReport() async {
    ...
    if (user == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('กรุณาเข้าสู่ระบบก่อนทำการแจ้งเหตุ'),
    ...
    if (!_formKey.currentState!.validate()) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('กรุณาตรวจสอบข้อมูลช่องสีแดงให้ครบถ้วน'),
          backgroundColor: Colors.red,
    ...
    switch (_selectedCategory) {
      case 'flood':
        specificData = {
          ...
          'people_count': _floodHasPeopleWaiting
              ? (int.tryParse(_floodPeopleCountController.text) ?? 0)
              : 0,
          ...
          'medical_needs': {
            ...
            'med_name': _floodNeedMeds
                ? _floodMedicationController.text.trim()
                : null,
            'severe_disease': _floodSevereDisease,
            'disease_name': _floodSevereDisease
                ? _floodDiseaseController.text.trim()
                : null,
          },
        };
        break;
      case 'fire':
        specificData = {
          'fire_type': _fireType,
          'status': _fireStatus,
          'has_trapped': _fireHasTrapped,
          'trapped_count': _fireHasTrapped
              ? (int.tryParse(_fireTrappedCountCtrl.text) ?? 0)
              : 0,
          'building_floors': int.tryParse(_fireFloorsCtrl.text) ?? 0,
          'nearby_risk': _fireRisk,
          'water_source': _fireWaterSource,
          'urgent_needs': _fireNeeds.entries
      ...
      case 'collapse':
        specificData = {
          'feeling': _eqFeeling,
          'damage': _eqDamage,
          'has_trapped': _eqHasTrapped,
          'trapped_count': _eqHasTrapped
              ? (int.tryParse(_eqTrappedCountCtrl.text) ?? 0)
              : 0,
          'secondary_risk': _eqRisk,
          'utilities_status': _eqUtilities.entries
              .where((e) => e.value == true)
              .map((e) => e.key)
              .toList(),
          'urgent_needs': _eqNeeds.entries
              .where((e) => e.value == true)
              .map((e) => e.key)
              .toList(),
        };
      ...
      case 'chemical':
        specificData = {
          'characteristics': _chemChar,
          'color': _chemColor,
          'symptoms': _chemHasInjured ? _chemSymptom : null,
          'wind_direction': _chemWind,
          'affected_area': _chemArea,
          'has_injured': _chemHasInjured,
          'injured_count': _chemHasInjured
              ? (int.tryParse(_chemInjuredCtrl.text) ?? 0)
              : 0,
          'urgent_needs': _chemNeeds.entries
              .where((e) => e.value == true)
              .map((e) => e.key)
              .toList(),
        };
      ...
      case 'violence':
        specificData = {
          'type': _violType,
          'weapon': _violWeapon,
          'suspect_status': _violStatus,
          'fled_vehicle_detail': _violStatus == 'หลบหนีไปแล้ว'
              ? _violFledVehicleCtrl.text.trim()
              : null,
          'suspect_info': _violSuspectCtrl.text.trim(),
          'has_injured': _violHasInjured,
          'injured_count': _violHasInjured
              ? (int.tryParse(_violInjuredCtrl.text) ?? 0)
              : 0,
          'injury_type': _violHasInjured ? _violInjuryType : null,
          'reporter_safety': _violSafety,
          'urgent_needs': _violNeeds.entries
              .where((e) => e.value == true)
              .map((e) => e.key)
              .toList(),
        };
      ...
      case 'other':
        specificData = {
          ...
          'affected_count': _otherHasAffected
              ? (int.tryParse(_otherAffectedCtrl.text) ?? 0)
              : 0,
          'extra_note': _detailController.text.trim(),
          'urgent_needs': _otherNeeds.entries
              .where((e) => e.value == true)
              .map((e) => e.key)
              .toList(),
        };
    ...
    try {
      ...
      final reporterName = reporterFullName.isEmpty
          ? 'ไม่ระบุชื่อ'
          : reporterFullName;
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('แจ้งเหตุสำเร็จ! เจ้าหน้าที่กำลังตรวจสอบ'),
            behavior: SnackBarBehavior.floating,
          ),
        );
      }
